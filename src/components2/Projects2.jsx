...
const Projects2 = () => {
    ...
    return (
        ...
        >
            ...
            <div className="mainContent_header_wrapper">
                <div className="mainContent__header">
                    <div className="mainContent__nav">
                        <nav className="navbar navbar-expand-lg navbar-dark py-0">
                            <div className="">
                                <h4 className="navbar-brand project__body_title" >Click image to see demo</h4>
                            </div>
                            ...
                            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                                <div className="navbar-nav ml-auto">
                                    <a onClick={(_) => (gotoCommentSection(), setShow(state), setActive("all"))} className={`nav-item nav-link ${active === 'all' && 'project_item_active'}`} >All</a>
                                    <a onClick={(_) => (gotoCommentSection(), filterdata('django'))} className={`nav-item nav-link ${active === 'django' && 'project_item_active'}`}  >Django</a>
                                    <a onClick={(_) => (gotoCommentSection(), filterdata('react'))} className={`nav-item nav-link ${active === 'react' && 'project_item_active'}`}  >React</a>
                                    <a onClick={(_) => (gotoCommentSection(), filterdata('android'))} className={`nav-item nav-link ${active === 'android' && 'project_item_active'}`}  >Android</a>
                                    <a onClick={(_) => (gotoCommentSection(), filterdata('flutter'))} className={`nav-item nav-link ${active === 'flutter' && 'project_item_active'}`}  >Flutter</a>
                                    <a onClick={(_) => (gotoCommentSection(), filterdata('firebase'))} className={`nav-item nav-link ${active === 'firebase' && 'project_item_active'}`}  >Fierbase</a>
                                </div>
                            </div>
                        </nav>
                    </div>
                ...
                <div className="project_all_data_wrapper">
                    <div className="row m-0 p-0" ref={commentSection} >
                        {
                            show.map((data, i) => (
